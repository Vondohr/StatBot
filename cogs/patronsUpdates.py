...
class Supporters(commands.Cog):
    def __init__(self, bot):
        ...
        self.embeds_config = {
            "Ultra Supporters": {
                ...
                "image_url": "https://cdn.discordapp.com/attachments/.../UltraSupporter.gif",
                "message_id": None
            },
            "Top Supporters & Boosters": {
                "roles": ["Top Supporter", "Server Booster"],
                "color": discord.Color.blurple(),
                "image_url": "https://cdn.discordapp.com/attachments/.../TopSupporter.gif",
                "message_id": None
            },
            "Supporters": {
                "roles": ["Supporter"],
                "color": discord.Color.green(),
                "image_url": "https://cdn.discordapp.com/attachments/.../Supporter.gif",
                "message_id": None
            },
        }
    ...
    async def cog_load(self):
        ...
        # Register guild-only command for instant appearance
        guild = discord.Object(id=self.bot.guilds[0].id)  # first guild
        self.bot.tree.add_command(self.refresh_supporters, guild=guild)
        try:
            await self.bot.tree.sync(guild=guild)
            print(f"[Supporters] Synced commands to guild {guild.id}")
        except Exception as e:
            print(f"[Supporters] Failed to sync: {e}")
